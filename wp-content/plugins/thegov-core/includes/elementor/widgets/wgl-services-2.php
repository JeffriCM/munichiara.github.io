...
class Wgl_Services_2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Services 2', 'thegov-core' );
    }
    ...
    protected function register_controls() {
        ...
        $output['media_width'] = array(
            'label' => esc_html__( 'Media Width(Height)', 'thegov-core' ),
        ...
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Services 2 ', 'thegov-core'), 'output' => $output,'section' => true, 'prefix' => '' ) );
        ...
        $this->start_controls_section(
            'section_style_link',
            [
                'label' => esc_html__( 'Service Link', 'thegov-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'solid' => esc_html__( 'Solid', 'Border Control', 'thegov-core' ),
                    'double' => esc_html__( 'Double', 'Border Control', 'thegov-core' ),
                    'dotted' => esc_html__( 'Dotted', 'Border Control', 'thegov-core' ),
                    'dashed' => esc_html__( 'Dashed', 'Border Control', 'thegov-core' ),
                    'groove' => esc_html__( 'Groove', 'Border Control', 'thegov-core' ),
                ],
                'default' => 'dashed',
                'selectors' => [
        ...
        $this->add_control(
            'circle_width',
            [
                'label' => esc_html__( 'Circles Width(Height)', 'thegov-core' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 2,
                'step' => 1,
                'default' => 8,
        ...
        $this->add_control(
            'circle_color_1',
            [
                'label' => esc_html__( 'First Circle Color', 'thegov-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $second_color,
                'selectors' => [
        ...
        $this->add_control(
            'circle_color_2',
            [
                'label' => esc_html__( 'Second Circle Color', 'thegov-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => $second_color,
                'selectors' => [
