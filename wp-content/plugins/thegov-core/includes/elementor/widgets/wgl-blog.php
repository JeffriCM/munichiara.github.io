...
class Wgl_Blog extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Wgl Blog', 'thegov-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'hide_likes',
            array(
                'label'        => esc_html__('Hide Likes?','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'hide_share',
            array(
                'label'        => esc_html__('Hide Post Share?','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'crop_square_img',
            array(
                'label'        => esc_html__('Crop Images for Posts List?','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'custom_blog_mask',
            array(
                'label'        => esc_html__('Add Image Idle Overlay','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Add Image Hover Overlay','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'custom_blog_bg_item',
            array(
                'label'        => esc_html__('Add Items Background','thegov-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'thegov-core' ),
                'label_off'    => esc_html__( 'Off', 'thegov-core' ),
                'return_value' => 'yes',
